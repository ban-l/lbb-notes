...
```mermaid
flowchart TB
    subgraph ThreadSafe["线程安全集合"]
        subgraph List["List"]
            CV["CopyOnWriteArrayList"]
            V["Vector"]
        end

        subgraph Set["Set"]
            CWS["CopyOnWriteArraySet"]
            CS["ConcurrentSkipListSet"]
        end

        subgraph Map["Map"]
            CHM["ConcurrentHashMap"]
            CSMap["ConcurrentSkipListMap"]
            HT["Hashtable"]
        end
        ...
        subgraph Queue["Queue"]
            ...
            CBQ["ConcurrentLinkedQueue"]
        end
    end

    style CHM fill:#4ecdc4,color:#fff
...
flowchart TB
    ...
    style JDK18 fill:#4ecdc4,color:#fff
```
