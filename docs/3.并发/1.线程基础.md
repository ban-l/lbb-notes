...
flowchart TB
    ...
    style P1_Heap fill:#ffd93d
    style P1_Code fill:#ffd93d
    style P1_Data fill:#ffd93d
```
...
stateDiagram-v2
    ...
    Waiting --> Runnable: notify()/时间到/interrupt()
